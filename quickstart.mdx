...
Before we start, there are two ways to install PulsejetDB:
* Locally as a package from PyPi. This is local installation and meant to be used for rapid prototyping.
